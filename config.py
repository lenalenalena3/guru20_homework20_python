...
from project_android.utils.file import abs_path_from_project
...
def get_settings(context: Literal["local_emulator", "local_real", "bstack"]) -> BaseAppSettings:
    if context == "local_emulator":
        return LocalEmulatorSettings()
    elif context == "local_real":
        return LocalRealSettings()
    elif context == "bstack":
...
def driver_options(context: Literal["local_emulator", "local_real", "bstack"]) -> UiAutomator2Options:
